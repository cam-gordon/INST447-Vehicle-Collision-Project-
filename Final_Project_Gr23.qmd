...
null and missing values from incompleted accident reports, so we dropped all missing records to avoid data noise or outlier while analyzing
or visualizing data trends. 
...
You are encouraged to structure this major section into subsections as you
 wish, and to break up and interweave code chunks, to help with organization 
 and readability.
...
- Create CSV files to import the data into our dataset
- Create sample tables using SQL queries
